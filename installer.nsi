...
; Then modified by Justin Dearing.
...
OutFile "PlaneDisaster.NET-Setup-${PRODUCT_VERSION}.exe"
InstallDir "$PROGRAMFILES\PlaneDisaster.NET"
InstallDirRegKey HKLM "${PRODUCT_DIR_REGKEY}" ""
ShowInstDetails show
ShowUnInstDetails show

; Install Start menu items under all users
!define ALL_USERS
...
Section "PlaneDisaster.NET" SEC01
  ...
  File ".\bin\Release\PlaneDisaster.LIB.dll"
